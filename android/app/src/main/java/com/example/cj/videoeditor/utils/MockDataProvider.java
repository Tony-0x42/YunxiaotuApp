...
public class MockDataProvider {
    ...
    public static List<Banner> getBanners() {
        ...
        list.add(new Banner("1", "https://placehold.co/600x300/2196F3/FFFFFF?text=Banner1", "", 1, "Banner1"));
        list.add(new Banner("2", "https://placehold.co/600x300/1976D2/FFFFFF?text=Banner2", "", 2, "Banner2"));
        list.add(new Banner("3", "https://placehold.co/600x300/64B5F6/FFFFFF?text=Banner3", "", 3, "Banner3"));
        return list;
    }
    ...
    public static List<HomeMenu> getHomeMenus() {
        ...
        list.add(new HomeMenu("学习专区", R.drawable.ic_learning));
        list.add(new HomeMenu("信息咨询", R.drawable.ic_contact));
        list.add(new HomeMenu("品牌专区", R.drawable.ic_brand));
        list.add(new HomeMenu("其他服务", R.drawable.ic_other_service));
        return list;
    }

    public static Banner getTutorialEntry() {
        return new Banner("tutorial", "https://placehold.co/600x200/2196F3/FFFFFF?text=新手指南", "", 1, "新手指南");
    }
    ...
    public static List<Material> getMockMaterials() {
        ...
        list.add(new Material("v1", "快速入门：AI 去水印", Material.Type.VIDEO,
                "https://placehold.co/200x120/2196F3/FFFFFF?text=Video1", "",
                "2024-06-01", 1200));
        list.add(new Material("d1", "账号层级说明", Material.Type.DOCUMENT,
                "https://placehold.co/200x120/757575/FFFFFF?text=Doc1", "",
                "2024-06-02", 800));
        list.add(new Material("p1", "批量剪辑 使用手册", Material.Type.PDF,
                "https://placehold.co/200x120/FB8C00/FFFFFF?text=PDF1", "",
                "2024-06-03", 500));
        return list;
    }
    ...
    public static Contact getMockOnlineService() {
        return new Contact("在线客服", "", "400-888-6666", "online");
    }

    public static Contact getMockHeadquarter() {
        return new Contact("总部热线", "", "400-888-8888", "headquarter");
    }

    public static List<Contact> getMockContacts() {
        List<Contact> list = new ArrayList<>();
        list.add(new Contact("张伟", "华东区", "13800138001"));
        list.add(new Contact("李娜", "华北区", "13800138002"));
        list.add(new Contact("王强", "华南区", "13800138003"));
        return list;
    }
    ...
    public static List<Document> getMockDocuments() {
        List<Document> list = new ArrayList<>();
        list.add(new Document("q1", "如何快速去除视频水印", "快速上手", "2024-06-01",
                "1. 复制短视频平台分享链接；\n2. 打开 AI 去水印页面粘贴链接；\n3. 点击解析并等待处理完成；\n4. 预览去水印结果后点击保存。"));
        list.add(new Document("o1", "AI 云创分镜头管理", "操作指南", "2024-06-02",
    ...
    public static User getMockUser() {
        return new User("15912341415", "批量剪辑用户", "",
                true, "2029-05-24", 1000, 356);
    }
